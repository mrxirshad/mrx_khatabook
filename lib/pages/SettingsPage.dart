...
import 'package:khatabook/utils/settings.dart';
            ...
            children: [
              ...
              const Padding(
                ...
                child: Column(
                  children: [
                    SettingsTile(
                      text: "Name",
                      route: CupertinoIcons.arrow_right_circle,
                    ...
                    SettingsTile(
                      text: "GSTIN",
                      route: CupertinoIcons.arrow_right_circle,
                      icons: CupertinoIcons.greaterthan_square,
                    ),
                    SizedBox(
                      height: 20,
                    ),
                    ...
                    SettingsTile(
                      text: "Change to Supplier",
                      route: CupertinoIcons.arrow_right_circle,
                      icons: CupertinoIcons.rotate_right,
                    ),
                  ],
                ),
              ),
              ...
              const Padding(
                ...
                child: Column(
                  children: [
                    SettingsTile(
                        text: "Customer SMS Settings",
                        route: CupertinoIcons.arrow_right_circle,
                        icons: CupertinoIcons.chat_bubble_text),
                    SizedBox(
                      height: 20,
                    ),
                    SettingsTile(
                        text: "SMS Language",
                        route: CupertinoIcons.arrow_right_circle,
                        icons: CupertinoIcons.arrow_up_arrow_down_square),
                    SizedBox(
                      height: 20,
                    ),
                    SettingsTile(
                        text: "Transactions History Link",
                        route: CupertinoIcons.arrow_right_circle,
                        icons: CupertinoIcons.link),
                    SizedBox(
                      height: 20,
                    ),
                  ],
